$(function() {
		...
		function addFormAction(){
			...
			$('#myForm').unbind('submit').submit(function(){
				getContent();
				var form = $(this);
				var url = Routing.generate('secourut_admin_secourisme_add');
				...
				$.ajax({
						...
						success: function(response)
						{
							...
							$.ajax({
									type: 'POST',
									url:  Routing.generate('secourut_admin_secourisme'),
									data: form.serialize(),
									dataType: 'html',
									success: function(response)
									{
		...
		function updateFormAction(){
			...
			$('#myForm').submit(function(){
				...
				var url = Routing.generate('secourut_admin_secourisme_saveModif', { id: id });
		...
		function cancelFormAction(){
			...
			$('#cancel').click(function(){
				...
				$.ajax({
						type: 'POST',
						url:  Routing.generate('secourut_admin_secourisme_cancel'),
						success: function(response)
						{
							$('#form_container').html(response);
							ckeditor();
        ...
        function modifAction(){
			...
			$('input[id^="m_"]').unbind('click').click(function(){
				...
				$.ajax({
						type: 'POST',
						url:  Routing.generate('secourut_admin_secourisme_modif'),
						data: 'id=' + id,
					...
					modal: true,
					  buttons: {
						"Oui": function() {
							  ...
							  $.ajax({
									type: 'POST',
									url:  Routing.generate('secourut_admin_secourisme_delete'),
									data: 'id=' + id,
